...
for mes in sys.argv[1:]:
    sinasc = pd.read_csv(f'https://raw.githubusercontent.com/junioralves/Curso_EBAC-Profissao_Cientista_de_Dados/main/Mo%CC%81dulo%2014%20-%20Scripting/database/input/SINASC_RO_2019_{mes}.csv')
