...
def main():
    ...
    bank_raw = load_data(
        file_data='https://raw.githubusercontent.com/junior141981/Curso_EBAC-Profissao_Cientista_de_Dados/main/Mo%CC%81dulo_19_-_Streamlit_II/Exerci%CC%81cio_1/data/input/bank-additional-full.csv', sep=';')
    bank = bank_raw.copy()
